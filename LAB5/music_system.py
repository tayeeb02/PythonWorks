...
def makeCrazyMusic():
    ...
    #for i in range(10):
     #   print(i)
     #Notes are inclusive. Start 60, end 64, both inclusive in notes. 
    ...
    for i in range(number_of_repeat):
        ...
        if pitch_range>0:
            ...
            for pitch in range(start_pitch, start_pitch + pitch_range, -1): #this -1 is crucial because by default python moves up 1 step not down.
