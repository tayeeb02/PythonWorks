...
#In case of width and height, what it will do is assign 900 to height and 564 to width
...
turtle.speed(6)                            # Making turtle faster
...
for i in range(firework_count):
    ...
    directions= random.randint(10,20)
